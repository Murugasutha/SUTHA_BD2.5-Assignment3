...
function sortPriceByHighToLow(hotel1, hotel2) {
  return hotel2.price - hotel1.price;
}
function sortPriceByLowToHigh(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'high-to-low') {
    hotelCopy.sort(sortPriceByHighToLow);
  } else {
    hotelCopy.sort(sortPriceByLowToHigh);
  }
...
function sortRatingByHighToLow(hotel1, hotel2) {
  return hotel2.rating - hotel1.rating;
}
function sortRatingByLowToHigh(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'high-to-low') {
    hotelCopy.sort(sortRatingByHighToLow);
  } else {
    hotelCopy.sort(sortRatingByLowToHigh);
  }
  res.json({ hotels: hotelCopy });
});
...
function sortReviewsByMostToLeast(hotel1, hotel2) {
  return hotel2.reviews - hotel1.reviews;
}
function sortReviewsByLeastToMost(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'most-to-least') {
    hotelCopy.sort(sortReviewsByMostToLeast);
  } else {
    hotelCopy.sort(sortReviewsByLeastToMost);
  }
  res.json({ hotels: hotelCopy });
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let filteredhotel = hotels.filter((hotel) => filterByAmenity(hotel, amenity));
  res.json({ hotels: filteredhotel });
});
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let filteredhotel = hotels.filter((hotel) => filterByCountry(hotel, country));
  res.json({ hotels: filteredhotel });
});
...
app.get('/hotels/filter/category', (req, res) => {
  ...
  let filteredhotel = hotels.filter((hotel) =>
